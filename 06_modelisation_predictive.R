...
write_csv2(tableau_perf, "resultats/predictif/performances_regression.csv")
...
write_csv2(importance_vars, "resultats/predictif/importance_variables.csv")
...
perf_classif <- data.frame(
  ...
  Accuracy = matrice_confusion$overall["Accuracy"],
  Precision = matrice_confusion$byClass["Precision"],
  Rappel = matrice_confusion$byClass["Recall"]
)

print(perf_classif, row.names = FALSE)

# Export résultats
write_csv2(as.data.frame(matrice_confusion$table), "resultats/predictif/matrice_confusion.csv")
write_csv2(perf_classif, "resultats/predictif/performance_classification.csv")
...
write_csv2(importance_classif, "resultats/predictif/importance_classif.csv")
